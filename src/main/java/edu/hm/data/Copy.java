 ...
 */
public class Copy {
	/** Diese Variable enthält eine Referenz auf das konkrete Medium, auf welches diese Copy verweist. */
	...
	/**
	 * Ctor für eine Copy.
	 * @param owner Der Besitzer dieser Copy
	 * @param medium Das Medium, auf welches diese Copy verweist
	 */
