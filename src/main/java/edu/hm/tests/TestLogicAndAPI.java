...
// assertEquals("A book with the given ISBN is already present in the
// database.", result.getDetail());
...
// assertEquals("No Book exists with the given ISBN. Modification of the Book
// aborted.", result.getDetail());
//
// testBook = new Book(null, "2", isbn); // no title
...
// assertEquals("No Disc exists with the given Barcode. Modification of the Disc
// aborted.", result.getDetail());
//
// testDisc = new Disc(null, "2", barcode, 0); // no title
